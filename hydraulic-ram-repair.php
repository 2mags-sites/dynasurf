...
$content = loadContent('hydraulic-ram-repair');
...
?>
    ...
    <main class="section" style="padding-top: 3rem;">
        <div class="container">
            ...
            <div class="content-with-image">
                <div class="story-box">
                    <h3>What is Hydraulic Ram Repair?</h3>
                ...
                <div class="content-image">
                    <?php echo editableImage($content['overview']['image'], 'overview.image', 'Hydraulic ram being repaired in workshop', 'Hydraulic Ram Repair Process'); ?>
                </div>
            </div>
            ...
            <div class="section" style="margin-top: 4rem;">
                ...
                <div class="content-with-image" style="margin-top: 2rem;">
                    ...
                    <div class="content-image">
                        <?php echo editableImage($content['capabilities']['image'], 'capabilities.image', 'Technical equipment for cylinder testing', 'Hydraulic Testing Equipment'); ?>
                    </div>
                </div>
            </div>
    ...
    <section class="section cogs-bg-left" style="margin-top: 4rem;">
        <div class="container">
            <div class="content-with-image">
                <div class="story-box">
                    <h3><?php echo editable($content['applications']['title'], 'applications.title'); ?></h3>
                    <p><?php echo editable($content['applications']['content'], 'applications.content'); ?></p>
                    <div class="features-list" style="margin: 1.5rem 0;">
                        <?php if (isset($content['applications']['industries']) && is_array($content['applications']['industries'])): ?>
                            <?php foreach ($content['applications']['industries'] as $index => $industry): ?>
                                <div class="feature-item">
                                    <div class="feature-icon"><?php echo editable($industry['icon'], 'applications.industries.' . $index . '.icon'); ?></div>
                                    <div class="feature-text">
                                        <h4><?php echo editable($industry['title'], 'applications.industries.' . $index . '.title'); ?></h4>
                                        <p><?php echo editable($industry['description'], 'applications.industries.' . $index . '.description'); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <div class="content-image">
                    <?php echo editableImage($content['applications']['image'], 'applications.image', 'Various industrial hydraulic cylinders', 'Industrial Hydraulic Applications'); ?>
                </div>
            </div>
        </div>
    </section>
